...
static const Rule rules[] = {
  ...
  RULE(.class = "python", .isfloating = 1, .noswallow = 1, .floatpos = "75% 75%")
  RULE(.title = "Figure 1", .isfloating = 1, .noswallow = 1, .floatpos = "75% 75%")
  RULE(.title = "Figure 2", .isfloating = 1, .noswallow = 1, .floatpos = "75% 75%")
  RULE(.instance = "gnuplot_qt", .isfloating = 1, .noswallow = 1, .floatpos = "75% 75%")
